...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${poppins.className} bg-gradient-to-r from-primary to-purple-950  text-secondary flex min-h-screen max-w-7xl flex-col justify-between w-full mx-auto`}
      >
        <Navbar />
